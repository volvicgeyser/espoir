                     ...
                     int       nCmdShow)
{
	...
	//DirectX初期化
	if(espoir::DDevice::Init()){
	}

	//DirectXのメインループ
	espoir::DDevice::DMainLoop();
	...
	LoadString(hInstance, IDC_ESPOIR, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_ESPOIR));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_ESPOIR));
